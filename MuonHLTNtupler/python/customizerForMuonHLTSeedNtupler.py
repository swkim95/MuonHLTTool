...
def customizerFuncForMuonHLTSeedNtupler(process, newProcessName = "MYHLT", doDYSkim = False):
    ...
    process.seedNtupler.mvaFileHltIter2IterL3FromL1MuonPixelSeeds_B_0                = cms.FileInPath("RecoMuon/TrackerSeedGenerator/data/xgb_Phase2_Barrel_NThltIter2FromL1_0.xml")
    ...
    process.seedNtupler.mvaFileHltIter2IterL3FromL1MuonPixelSeeds_E_0                = cms.FileInPath("RecoMuon/TrackerSeedGenerator/data/xgb_Phase2_Endcap_NThltIter2FromL1_0.xml")
