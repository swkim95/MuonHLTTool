...
def customizerFuncForMuonHLTSeedNtupler(process, newProcessName = "MYHLT", doDYSkim = False):
    ...
    process.seedNtupler.mvaFileHltIter2IterL3FromL1MuonPixelSeeds_B_0                = cms.FileInPath("HLTrigger/MuonHLTSeedMVAClassifier/data/PU200_DYToLL_M50_Barrel_NThltIter2FromL1_0.xml")
    process.seedNtupler.mvaFileHltIter2IterL3FromL1MuonPixelSeeds_B_1                = cms.FileInPath("HLTrigger/MuonHLTSeedMVAClassifier/data/PU200_DYToLL_M50_Barrel_NThltIter2FromL1_1.xml")
    process.seedNtupler.mvaFileHltIter2IterL3FromL1MuonPixelSeeds_B_2                = cms.FileInPath("HLTrigger/MuonHLTSeedMVAClassifier/data/PU200_DYToLL_M50_Barrel_NThltIter2FromL1_2.xml")
    process.seedNtupler.mvaFileHltIter2IterL3FromL1MuonPixelSeeds_B_3                = cms.FileInPath("HLTrigger/MuonHLTSeedMVAClassifier/data/PU200_DYToLL_M50_Barrel_NThltIter2FromL1_3.xml")
    ...
    process.seedNtupler.mvaFileHltIter2IterL3FromL1MuonPixelSeeds_E_0                = cms.FileInPath("HLTrigger/MuonHLTSeedMVAClassifier/data/PU200_DYToLL_M50_Endcap_NThltIter2FromL1_0.xml")
    process.seedNtupler.mvaFileHltIter2IterL3FromL1MuonPixelSeeds_E_1                = cms.FileInPath("HLTrigger/MuonHLTSeedMVAClassifier/data/PU200_DYToLL_M50_Endcap_NThltIter2FromL1_1.xml")
    process.seedNtupler.mvaFileHltIter2IterL3FromL1MuonPixelSeeds_E_2                = cms.FileInPath("HLTrigger/MuonHLTSeedMVAClassifier/data/PU200_DYToLL_M50_Endcap_NThltIter2FromL1_2.xml")
    process.seedNtupler.mvaFileHltIter2IterL3FromL1MuonPixelSeeds_E_3                = cms.FileInPath("HLTrigger/MuonHLTSeedMVAClassifier/data/PU200_DYToLL_M50_Endcap_NThltIter2FromL1_3.xml")
