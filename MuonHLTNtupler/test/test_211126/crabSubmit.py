...
mainOutputDir = '/store/user/sungwon/PhaseII/20211125'
    ...
    for menu in HLT_menus:
        ...
        for datasetTag, datasetPath in datasets:
            ...
            if 'PU0To200-DYToLL_M50' in datasetTag:
                ...
                crab_cfg_out = crab_cfg_out.replace("config.Data.outLFNDirBase = '/store/user/sungwon/PhaseII/20211125'", "config.Data.outLFNDirBase = '/store/user/sungwon/PhaseII/20211125/PU0To200-DYToLL_M50'")
            else:
                crab_cfg_out = crab_cfg_out.replace("config.Data.outLFNDirBase = '/store/user/sungwon/PhaseII/20211125'", "config.Data.outLFNDirBase = '/store/user/sungwon/PhaseII/20211125/PU200-DYToLL_M50'")
