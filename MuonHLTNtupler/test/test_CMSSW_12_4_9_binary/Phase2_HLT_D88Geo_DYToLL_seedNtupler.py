...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/mc/PhaseIISpring22DRMiniAOD/DYToLL_M-50_TuneCP5_14TeV-pythia8/GEN-SIM-RECO/PU200_BSzpz35_123X_mcRun4_realistic_v11_ext1-v1/2560000/01df93c7-f1d3-4ccb-a77c-41e9887c1cf2.root'),
...
# -- Aging, added from CMSSW_12_4_9 menu -- #
...
if doNtuple:
    ...
    process.ntupler.TkMuonToken                   = cms.InputTag("hltL1TkMuons", "", "MYHLT")
    ...
    process.seedNtupler.L1TkMuon                      = cms.untracked.InputTag("hltL1TkMuons", "", "MYHLT")
    ...
    # process.hltIter2Phase2L3FromL1TkMuonPixelSeedsFiltered.L1TkMu = cms.InputTag("hltL1TkMuons", "", "MYHLT")

process.hltL1TkMuons.applyQualityCuts = cms.bool(False)
...
process.HLT_Mu50_FromL1TkMuon_Open = cms.Path(
    ...
    cms.Task(
        ...
        # process.hltIter2Phase2L3FromL1TkMuonPixelSeedsFiltered, 
        process.hltIter2Phase2L3FromL1TkMuonTrackCutClassifier, 
        process.hltIter2Phase2L3FromL1TkMuonTrackSelectionHighPurity, 
        process.hltL1TkMuons, process.hltL2MuonFromL1TkMuonCandidates,
...
process.HLT_IsoMu24_FromL1TkMuon = cms.Path(
    ...
    cms.Task(
        ...
        process.hltPhase2L3MuonPixelTracksTrackingRegions,
