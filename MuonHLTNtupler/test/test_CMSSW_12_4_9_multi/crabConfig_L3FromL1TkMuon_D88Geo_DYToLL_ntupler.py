...
config.General.requestName = 'PU200-DYToLL_M-50_L3FromL1TkMuon_ntupler_20221010'
config.General.workArea = 'crab_PhaseII_CMSSW_12_4_9_20221010'

config.section_('JobType')
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'Phase2_HLT_D88Geo_DYToLL_ntupler.py'
...
config.Data.outLFNDirBase = '/store/user/sungwon/PhaseII_CMSSW_12_4_9/20221010/D88Geo_DYToLL_ntuple_for_Eff_check'
